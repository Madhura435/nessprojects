...
public class GlobalExceptionHandlingCar extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> ResourceNotFoundHandling(ResourceNotFoundException exception, WebRequest request) {
		ExceptionDetails exceptionDetails = new ExceptionDetails(new Date(),
				exception.getMessage() + " " + ",please change your id and colour", request.getDescription(false));
	...
	public ResponseEntity<?> WrongInputHandling(NullPointerException exception, WebRequest request) {
		...
		ExceptionDetails exceptionDetails = new ExceptionDetails(new Date(),
				exception.getMessage() + " ,please provide valid input details", request.getDescription(false));

		return new ResponseEntity<>(exceptionDetails, HttpStatus.NOT_FOUND);
	}

	@ExceptionHandler(RecordAlreadyExistException.class)
	public ResponseEntity<?> RecordAlredyExisting(RecordAlreadyExistException exception, WebRequest request) {
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		ExceptionDetails exceptionDetails = new ExceptionDetails(new Date(),
				ex.getMessage() + " ,Please change http method type", request.getDescription(false));
